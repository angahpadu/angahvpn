...
wget -q -O /usr/local/ctechdidik/xray-mini "https://raw.githubusercontent.com/angahpadu/angahvpn/main/xray-mini" 
...
# // Downloading Menu
wget -q -O /usr/bin/add-xray "https://raw.githubusercontent.com/angahpadu/angahvpn/main/add-xray.sh"
wget -q -O /usr/bin/del-xray "https://raw.githubusercontent.com/angahpadu/angahvpn/main/del-xray.sh"
wget -q -O /usr/bin/renew-xray "https://raw.githubusercontent.com/angahpadu/angahvpn/main/renew-xray.sh"
