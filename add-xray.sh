...
vless_direct="vless://${uuid}@${domain}:${vless1}?security=xtls&encryption=none&headerType=none&type=tcp&flow=xtls-rprx-direct&sni=angahproject.tech#$user"
vless_splice="vless://${uuid}@${domain}:${vless1}?security=xtls&encryption=none&headerType=none&type=tcp&flow=xtls-rprx-splice&sni=angahproject.tech#$user"
...
echo -e "================================="
echo -e "Gantikan angahproject.tech dengan BUG anda"
echo -e "================================="
